...
#define crypto_kem_keypair_based_on_input KYBER_NAMESPACE(keypair_based_on_input)
int crypto_kem_keypair_based_on_input(uint8_t *key_input, uint8_t *pk, uint8_t *sk);
